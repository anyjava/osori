var OsoriRoute = (function () {
    ...
    map.set("project.findAll",          "/projects");
    map.set("project.create",           "/project");
    map.set("project.findOne",          "/project/{id}");
    map.set("project.findUsersProject", "/project/{id}/users");
    map.set("project.findNavigationsProject", "/project/{id}/navigations");
